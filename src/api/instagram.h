...
signals:
    ...
    void setProfilePrivate(QVariant);
    void setProfilePublic(QVariant);
    void profileDataReady(QVariant);
    void editDataReady(QVariant);
    void usernameDataReady(QVariant);

    void recentActivityDataReady(QVariant);
    void followingRecentDataReady(QVariant);

    void userTagsDataReady(QVariant);
    void tagFeedDataReady(QVariant);

    void mediaLikersDataReady(QVariant);
    void mediaCommentsDataReady(QVariant);
    void likeDataReady(QVariant);
    void unLikeDataReady(QVariant);

    void followDataReady(QVariant);
    void unFollowDataReady(QVariant);
    void blockDataReady(QVariant);
    void unBlockDataReady(QVariant);
    void userFriendshipDataReady(QVariant);
    void likedMediaDataReady(QVariant);

    void doLogout(QVariant);
