...
public slots:
    ...
    Q_INVOKABLE void infoMedia(QString mediaId);
    Q_INVOKABLE void editMedia(QString mediaId, QString captionText = "");
    Q_INVOKABLE void deleteMedia(QString mediaId);
    Q_INVOKABLE void removeSelftag(QString mediaId);

    Q_INVOKABLE void postComment(QString mediaId, QString commentText);
    Q_INVOKABLE void deleteComment(QString mediaId, QString commentId, QString captionText);
    ...
    Q_INVOKABLE void getProfileData();
    Q_INVOKABLE void editProfile(QString url, QString phone, QString first_name, QString biography, QString email, bool gender);
    Q_INVOKABLE void getUsernameInfo(QString usernameId);

    Q_INVOKABLE void getRecentActivity();
    Q_INVOKABLE void getFollowingRecentActivity();

    Q_INVOKABLE void getUserTags(QString usernameId);
    Q_INVOKABLE void tagFeed(QString tag);
    Q_INVOKABLE void userFeed(QString user);
    Q_INVOKABLE void exploreFeed(QString session_id="");
    Q_INVOKABLE void storiesFeed(QString session_id="");

    Q_INVOKABLE void getTimeLine(QString max_id = "");
    Q_INVOKABLE void getUsernameFeed(QString usernameID, QString maxid = "", QString minTimestamp = "");
    Q_INVOKABLE void getPopularFeed();

    Q_INVOKABLE void getMediaLikers(QString mediaId);
    Q_INVOKABLE void getMediaComments(QString mediaId);

    Q_INVOKABLE void like(QString mediaId);
    Q_INVOKABLE void unLike(QString mediaId);
    ...
    Q_INVOKABLE void userFriendship(QString userId);
    Q_INVOKABLE void getLikedMedia(QString maxid = "");

    Q_INVOKABLE void getUserFollowings(QString userId, QString maxId = "");
    Q_INVOKABLE void getUserFollowers(QString userId, QString maxId = "");
    ...
    Q_INVOKABLE void getInbox();
    Q_INVOKABLE void getDirectThread(QString threadId);
